export const SIM_DEFAULTS = {
  ...
  DEFAULT_SPEED: 120,      // 120x speed so a full day takes ~12 minutes (great for demos)
  MAX_SPEED: 1440,
  MIN_SPEED: 1,
} as const;
...
export const HOUSE_CONFIGS = [
  { name: 'Alpha',   emoji: '🏠', solarCapacity: 9.0, batteryCapacity: 12.0, baseLoad: 1.5, posX: 300, posY: 100 },
  { name: 'Beta',    emoji: '🏡', solarCapacity: 7.0, batteryCapacity: 8.0,  baseLoad: 2.0, posX: 550, posY: 80 },
  { name: 'Gamma',   emoji: '🏘️', solarCapacity: 12.0, batteryCapacity: 15.0, baseLoad: 1.2, posX: 700, posY: 250 },
  { name: 'Delta',   emoji: '🏗️', solarCapacity: 4.5, batteryCapacity: 6.0,  baseLoad: 2.5, posX: 650, posY: 450 },
  { name: 'Epsilon', emoji: '🏢', solarCapacity: 8.0, batteryCapacity: 10.0, baseLoad: 3.0, posX: 400, posY: 500 },
  { name: 'Zeta',    emoji: '🏛️', solarCapacity: 10.5, batteryCapacity: 14.0, baseLoad: 1.8, posX: 150, posY: 450 },
  { name: 'Eta',     emoji: '🏠', solarCapacity: 6.0, batteryCapacity: 7.0,  baseLoad: 1.0, posX: 100, posY: 250 },
  { name: 'Theta',   emoji: '🏡', solarCapacity: 7.5, batteryCapacity: 10.0, baseLoad: 2.2, posX: 400, posY: 300 },
] as const;
